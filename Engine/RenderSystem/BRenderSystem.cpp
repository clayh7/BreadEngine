...
void BRenderSystem::ClearScreen(const Color & clearColor)
{
	...
	// Setting the clear color takes a long time if done every frame
	if(clearColor != RSystem->m_currentClearColor)
	{
		RSystem->m_currentClearColor = clearColor;
...
//-------------------------------------------------------------------------------------------------
BRenderSystem::BRenderSystem()
	: m_activeFBO(nullptr)
	, m_activeCamera(new Camera3D(false))
...
//-------------------------------------------------------------------------------------------------
void BRenderSystem::InitializeOpenGL()
{
	//---------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------
GLuint BRenderSystem::CreateSampler(GLenum const &min_filter, GLenum const &mag_filter, GLenum const &u_wrap, GLenum const &v_wrap)
{
	GLuint samepler_id;
...
//-------------------------------------------------------------------------------------------------
GLuint BRenderSystem::CreateRenderBuffer(void const *data, size_t count, size_t elem_size, GLenum const &usage /*= GL_STATIC_DRAW*/)
{
	GLuint buffer;
...
//-------------------------------------------------------------------------------------------------
GLuint BRenderSystem::CreateShader(std::string const &filename, GLenum shader_type)
{
...
//-------------------------------------------------------------------------------------------------
GLuint BRenderSystem::CreateAndLinkProgram(GLuint vs, GLuint fs, std::string const &debugFilepath)
{
...
//-------------------------------------------------------------------------------------------------
void BRenderSystem::UpdateRenderBuffer(GLuint bufferID, void const *data, size_t count, size_t elem_size, GLenum const &usage /*= GL_STATIC_DRAW*/)
{
...
//-------------------------------------------------------------------------------------------------
void BRenderSystem::CreateOrUpdateRenderBuffer(GLuint * bufferID, void const *data, size_t count, size_t elem_size, GLenum const &usage /*= GL_STATIC_DRAW */)
{
	if(*bufferID == NULL)
	{
...
//-------------------------------------------------------------------------------------------------
void BRenderSystem::BindMeshToVAO(GLuint vaoID, Mesh const *mesh, Material const *material)
{
...
//-------------------------------------------------------------------------------------------------
void BRenderSystem::BindShaderProgramProperty(int bindPoint, GLint count, GLenum type, GLboolean normalize, GLsizei stride, GLsizei offset)
{
	//Position to bind
	if(bindPoint >= 0)
	{
...
//-------------------------------------------------------------------------------------------------
void BRenderSystem::BindTextureSampler(GLuint samplerID, GLuint textureID, unsigned int textureIndexPort, int bindLocation)
{
	if(textureID != NULL)
	{
...
//-------------------------------------------------------------------------------------------------
GLenum BRenderSystem::GetVertexDataType(VertexDataType const & type) const
{
	switch(type)
	{
...
//-------------------------------------------------------------------------------------------------
void BRenderSystem::SetMatrixUniforms(MeshRenderer * setMeshRenderer)
{
...
//-------------------------------------------------------------------------------------------------
void BRenderSystem::MeshRender(MeshRenderer const * meshRenderer)
{
	//Set Render State
...
//-------------------------------------------------------------------------------------------------
void BRenderSystem::DeleteFramebuffer(Framebuffer *fbo)
{
	if(m_activeFBO == fbo)
	{
...
void BRenderSystem::BindFramebuffer(Framebuffer *fbo)
{
	if(m_activeFBO == fbo)
	{
		return;
...
//-------------------------------------------------------------------------------------------------
void BRenderSystem::ApplyRenderState(RenderState const &renderState)
{
...
//-------------------------------------------------------------------------------------------------
GLenum BRenderSystem::GetOpenGLDrawMode(const ePrimitiveType& drawMode) const
{
...
//-------------------------------------------------------------------------------------------------
void BRenderSystem::SetCullFace(bool enable)
{
...
//-------------------------------------------------------------------------------------------------
void BRenderSystem::SetDepthTest(bool enable)
{
	//No redundant actions
...
//-------------------------------------------------------------------------------------------------
void BRenderSystem::SetDepthWrite(bool enable)
{
	//No redundant actions
...
//-------------------------------------------------------------------------------------------------
void BRenderSystem::EnableAlphaTesting(float threshold /*= 0.5f */)
{
...
//-------------------------------------------------------------------------------------------------
void BRenderSystem::DisableAlphaTesting()
{
...
//-------------------------------------------------------------------------------------------------
void BRenderSystem::SetBlending(const eBlending& setBlendingMode)
{
	//No redundant actions
...
//-------------------------------------------------------------------------------------------------
void BRenderSystem::SetDrawMode(eDrawMode const &drawMode)
{
	//No redundant actions
...
//-------------------------------------------------------------------------------------------------
void BRenderSystem::SetWindingOrder(bool clockwise)
{
	//No redundant actions
...
//-------------------------------------------------------------------------------------------------
void BRenderSystem::SetLineWidth(float size)
{
...
//-------------------------------------------------------------------------------------------------
void BRenderSystem::SetPointSize(float size)
{
...
//-------------------------------------------------------------------------------------------------
std::string BRenderSystem::GetOpenGLVersion() const
{
...
//-------------------------------------------------------------------------------------------------
std::string BRenderSystem::GetGLSLVersion() const
{
...
//-------------------------------------------------------------------------------------------------
BitmapFont const * BRenderSystem::GetDefaultFont() const
{
...
//-------------------------------------------------------------------------------------------------
Framebuffer * BRenderSystem::GetActiveFBO() const
{
	return m_activeFBO;
}
